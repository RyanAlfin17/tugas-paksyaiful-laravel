...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=" {{ route('mastersiswa') }}">Siswa</a>
                        <a class="collapse-item" href="/admin/resource">Projects</a>
                        <a class="collapse-item" href="{{ route('editkontak') }}">Kontak</a>
                    </div>
                </div>
            </li>
    ...
    <script>
        $(document).ready(function() {
            // Find all elements with the "nav-link" class inside the sidebar
